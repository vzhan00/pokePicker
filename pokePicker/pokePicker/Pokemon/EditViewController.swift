...
class EditViewController: UIViewController {
    ...
    func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            move1TextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            move1TextField.topAnchor.constraint(equalTo: nameTextField.bottomAnchor, constant: 16),
            move1TextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
            
            move2TextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            move2TextField.topAnchor.constraint(equalTo: move1TextField.bottomAnchor, constant: 16),
            move2TextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
            
            move3TextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            move3TextField.topAnchor.constraint(equalTo: move2TextField.bottomAnchor, constant: 16),
            move3TextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
            
            move4TextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            move4TextField.topAnchor.constraint(equalTo: move3TextField.bottomAnchor, constant: 16),
            move4TextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ])
    }
